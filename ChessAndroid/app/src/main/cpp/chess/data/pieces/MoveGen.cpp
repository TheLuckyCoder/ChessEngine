...
PosVector<2> MoveGen::generatePawnAttacks(const Piece &piece, Pos pos)
{
	PosVector<2> moves;
...
PosVector<4> MoveGen::generatePawnMoves(const Piece &piece, Pos pos, const Board &board)
{
	PosVector<4> moves;
...
PosVector<8> MoveGen::generateKnightMoves(const Piece &piece, const Pos &pos, const Board &board)
{
	PosVector<8> moves;
...
PosVector<13> MoveGen::generateBishopMoves(const Piece &piece, const Pos &pos, const Board &board)
{
	PosVector<13> moves;
	Pos posCopy = pos;
...
PosVector<14> MoveGen::generateRookMoves(const Piece &piece, const Pos &pos, const Board &board)
{
	PosVector<14> moves;
	Pos posCopy = pos;
...
PosVector<27> MoveGen::generateQueenMoves(const Piece &piece, const Pos &pos, const Board &board)
{
	PosVector<27> moves;
...
PosVector<8> MoveGen::generateKingInitialMoves(Pos pos)
{
	PosVector<8> moves;
...
PosVector<8> MoveGen::generateKingMoves(const Piece &piece, const Pos &pos, const Board &board)
{
...
std::unordered_set<Pos> MoveGen::getAllAttacksPerColor(const bool white, const Board &board)
{
	std::unordered_set<Pos> attacks(48);
...
std::unordered_map<Pos, short> MoveGen::getAllMovesPerColor(const bool white, const Board &board)
{
