...
#define S Score
	 ...
	 */
	constexpr S PAWN_SCORE(128, 213);
	constexpr S KNIGHT_SCORE(781, 854);
	constexpr S BISHOP_SCORE(825, 915);
	constexpr S ROOK_SCORE(1276, 1380);
	constexpr S QUEEN_SCORE(2538, 2682);
...
const Psqt::ScoreArray Psqt::BONUS = [] {
	ScoreArray bonuses{};
